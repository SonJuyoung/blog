...
import com.jy.blog.model.KakaoProfile;
import com.jy.blog.model.OAuthToken;
...
//save함수는 id를 전달하지 않으면 insert를 하고, id를 전달하고 해당 id에 대한 데이터가 있으면 update, 데이터가 없으면 insert를 한다
...
public class UserController {
    ...
    public String kakaoCallback(String code) {//data를 리턴해주는 컨트롤러 함수
        ...
        //Retrofit2, OkHttp, RestTemplate 같은 라이브러리 사용
        ...
        params.add("client_id", "9e4d580513c9d730e50fe4b06a8a9167");
        ...
        //JSON데이터를 오브젝트에 담는 리이브러리 - Gson, Json Simple, ObjectMapper
        ...
        //Http 요청하기 - post방식 - respose 응답 받음
        ...
        //UUID는 중복되지 않는 어떤 특정 값을 만들어내는 알고리즘
